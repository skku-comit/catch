...
const Question12Page = () => {
  ...
  return (
    <div className={classes["page"]}>
      <ImageContainer Citizen={questionData.questions[11].characterImage} />
      <QuestionContainer
        Number={questionData.questions[11].id}
        Problem={questionData.questions[11].problem}
        Explain={questionData.questions[11].explanation}
        Image1={questionData.questions[11].image1}
        Image2={questionData.questions[11].image2}
        answer={questionData.questions[11].answer}
